...
$(function(){
	...
	parent.document.title = "dlpu_OA - " + document.title;
...
function browseFolder() {
	...
	try {
		...
		var Shell = new ActiveXObject("Shell.Application");//ActiveXObject是IE独有的对象
	...
	var url = pathName.substring(0, pathName.lastIndexOf('/') + 1) + "exportToExcel?folder=" + Folder;
...
function myBrowser(){
	...
	/*else if (userAgent.toLowerCase().indexOf("trident") > -1 && userAgent.indexOf("rv") > -1) {//判断是否IE11浏览器
		return "IE11";
	} */
	else {
		return "unknown";
