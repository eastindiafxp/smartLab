...
<head>
	...
	<link  type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/ckeditor/samples/css/sample.css">
...
<!--显示表单内容-->
<div id="MainArea">
<form action="saveReply.action" style="margin: 0; padding: 0;">
		...
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				...
				<tr height="240">
					...
					<td class="InputAreaBg"><div class="InputContent"><textarea id="reply" name="reply.content"></textarea></div></td>
				</tr>
				<tr height="30">
