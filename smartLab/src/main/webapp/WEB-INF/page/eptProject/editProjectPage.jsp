...
<head>
	<title>项目信息</title>
    <%@include file="/WEB-INF/page/publicPage/head.jsp" %>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td width="100">项目申请人：</td>
                        <td>
                        	<s:select id="claimer" theme="simple" cssClass="SelectStyle" name="claimerId" list="claimerList" listKey="id" listValue="loginName" headerKey="0" headerValue="请选择用户" disabled="true">
                            </s:select> *
                            <div id="showMsg5"></div>
                        </td>
                    </tr>
